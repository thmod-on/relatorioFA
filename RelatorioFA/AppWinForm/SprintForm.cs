...
namespace RelatorioFA.AppWinForm
{
    ...
    {
        public SprintForm(ContainerForm parentForm, UtilDTO.NAVIGATION fluxo)
        {
            InitializeComponent();
        ...
        public SprintForm(ContainerForm parentForm, UtilDTO.NAVIGATION fluxo, List<SprintBaseDTO> sprintsList)
        {
            InitializeComponent();
            ResizeParent(parentForm);
            this.fluxo = fluxo;
